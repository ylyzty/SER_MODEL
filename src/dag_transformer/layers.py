...
from dag_transformer.gnn_layers import get_simple_gnn_layer, EDGE_GNN_TYPES
...
class Attention(gnn.MessagePassing):
    ...
    def __init__(self, embed_dim, num_heads=8, dropout=0., bias=False, symmetric=False, gnn_type="gin", **kwargs):
...
class StructureExtractor(nn.Module):
    ...
    def __init__(self, embed_dim, gnn_type="gin", num_layers=3,
